...
class AutoProjectDetail extends React.Component{
    constructor(props){
        super(props)
        this.state ={
            projectEntity:{}
    ...
    render(){
        return (
            <Card title="项目详情" extra={<a href="#/demo/autoprojectmanagement">返回</a>} style={{ width: "100%" }}>
...
export default AutoProjectDetail;